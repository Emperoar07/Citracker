...
export const env = {
  ...
  ethRpcUrl: cleanString(process.env.ETH_RPC_URL),
  citreaRpcUrl: cleanString(process.env.CITREA_RPC_URL),
  ...
  etherscanApiUrl: cleanString(process.env.ETHERSCAN_API_URL, "https://api.etherscan.io/api"),
  etherscanApiKey: cleanString(process.env.ETHERSCAN_API_KEY),
  citreascanApiUrl: cleanString(process.env.CITREASCAN_API_URL, "https://explorer.mainnet.citrea.xyz/api/v2"),
  citreascanApiKey: cleanString(process.env.CITREASCAN_API_KEY),
  citreascanStatsUrl: cleanString(process.env.CITREASCAN_STATS_URL, "https://explorer.mainnet.citrea.xyz/api/v2/stats"),
  coinGeckoApiBase: cleanString(process.env.COINGECKO_API_BASE, "https://api.coingecko.com/api/v3"),
  coinGeckoDemoApiKey: cleanString(process.env.COINGECKO_DEMO_API_KEY),
  defillamaApiBase: cleanString(process.env.DEFILLAMA_API_BASE, "https://api.llama.fi"),
  ...
  duneApiBase: cleanString(process.env.DUNE_API_BASE, "https://api.dune.com/api/v1"),
  ...
  nansenApiBase: cleanString(process.env.NANSEN_API_BASE, "https://api.nansen.ai"),
