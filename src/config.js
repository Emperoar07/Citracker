...
export const env = {
  ...
  duneApiBase: process.env.DUNE_API_BASE || "https://api.dune.com/api/v1",
  duneApiKey: process.env.DUNE_API_KEY || "",
  duneQueryIdCitreaActivity: process.env.DUNE_QUERY_ID_CITREA_ACTIVITY || "",
  duneQueryIdCitreaFees: process.env.DUNE_QUERY_ID_CITREA_FEES || "",
  duneQueryIdCitreaDex: process.env.DUNE_QUERY_ID_CITREA_DEX || "",
